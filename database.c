...
==============================================================================*/
	...
	typedef struct diagnosis diagnosis_dt;
/*==============================================================================
...
==============================================================================*/
	...
	void save_patient(); 					   /* saves database to text file */
...
==============================================================================*/
	char temp_YN[5];
/*==============================================================================
	Request patients ID and Password for login. This will allow the patient to
	view their own file.
==============================================================================*/
    printf("Please enter the patients information filled out on the form.\n");
    printf("Enter the patients ID> ");
    scanf("%s", patient_lib[count].id);

        printf("Patients ID is %s\n", patient_lib[count].id);

    printf("Enter the patients password> ");
    scanf("%s", patient_lib[count].pass);

        printf("Patients password is %s\n", patient_lib[count].pass);
/*==============================================================================
...
==============================================================================*/
    ...
    scanf("%s", patient_lib[count].diagnosis_dt.med);

        printf("\nMedicine name is %s\n", patient_lib[count].diagnosis_dt.med);
...
int valid_patient(patient_t patient_lib[], int count)		/* checks if patient info entered is valid */
{
/*==============================================================================
	Declare Variables
==============================================================================*/
