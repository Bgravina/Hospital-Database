...
*******************************************************************************/
void print_debug(int valid_fullname_count, valid_time_count
, valid_measure_count, valid_med_count, valid_med_time_count
, valid_med_dose_count, valid_department_count, valid_level_count
, valid_room_count)
{
	printf("\n\n");
	printf("================================================================");
	...
	printf("\nPatients medicine dosage was entered incorrectly
